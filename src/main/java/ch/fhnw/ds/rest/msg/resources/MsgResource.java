...
/*
 ...
 curl -X PUT -i -H "Content-Type: application/xml"  --data "<ch.fhnw.ds.rest.msg.data.Msg><text>Hello, world!</text></ch.fhnw.ds.rest.msg.data.Msg>" http://localhost:9998/msg
